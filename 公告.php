...
<form method="get">
    <section id="blog-posts-2" class="blog-posts-2 section">
        <div class="container">
            ...
            <!-- 查詢表單 -->
             <div class="col-lg-6">
                <div class="form-group d-flex align-items-stretch" class="form-subscribe php-email-form">
                  <input type="text" id="search" name="search" placeholder="請輸入公告標題或內容" style="width: 300px; padding: 5px;">
                  <input type="submit" class="btn btn-secondary px-4" value="查詢">
                </div>
              </div>
